...
private:
    ...
    MultiBPlusTree<username_t, order_t, MULTI_BPLUSTREE_L, MULTI_BPLUSTREE_M> indexPool;
    MultiBPlusTree<trainID_t, order_t, MULTI_BPLUSTREE_L, MULTI_BPLUSTREE_M> pendingPool;
